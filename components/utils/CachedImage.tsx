...
const CachedImage: React.FC<CachedImageProps> = ({ src, alt, fallback, onLoad, onError, blurEffect = true, directLoad = false, ...props }) => {
  ...
  if (!directLoad && isLoading && blurEffect && !hasError) {
    return <img src={'/assets/System_Shop.webp'} alt={alt} {...props} style={{ filter: 'blur(8px)', ...props.style }} />;
  }
