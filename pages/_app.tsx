...
function AppContent({ Component, pageProps }: AppProps) {
  ...
  const BackgroundImage = () => {
    ...
    if (!mounted) {
      return (
        <div 
          className="fixed -z-10 top-0 left-0 w-screen h-screen pointer-events-none overflow-hidden object-cover bg-dark-gradient"
          aria-hidden="true"
        >
          ...
          <img
            ...
            alt="background"
            className="absolute top-0 left-0 w-screen h-screen object-cover opacity-5 blur-[3px] transition-opacity duration-800 max-w-full"
          />
