...
import { faGamepad, faStar, faBolt, faHandshake, faCode, faPalette, faFileText, faFlask, faRocket, faShield, faRobot, faChevronLeft, faChevronRight } from "@fortawesome/free-solid-svg-icons";
            ...
            {(() => {
                ...
                return (
                  <>
                    ...
                    <a className="text-neon-blue hover:text-neon-purple transition-colors">
                        <b>/oauth2/test</b>
                      </a>
                    </Link>
                    {after}
      ...
      return (
        <div className="glass-content-card mb-12">
          ...
          <div className="flex justify-center items-center py-12">
            ...
            <span className="ml-3" style={{color: 'var(--glass-text)'}}>Chargement...</span>
          </div>
        </div>
      );
    }
    ...
    return (
      <div className="glass-content-card mb-12">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={prevSlide}
            className="glass-button-neon w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0"
          >
                    ...
                    {game.bannerHash && (
                      <div className="absolute inset-0">
                        <ImageCache
                          ...
                          cacheKey={`banner_${game.gameId}`}
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-dark-primary via-transparent to-transparent opacity-60"></div>
                      </div>
                    )}
                    
                    <div className="absolute inset-0 bg-gradient-to-br from-neon-blue/10 via-neon-purple/5 to-neon-pink/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div className="relative z-10 p-6">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-4">
                          {/* Icône du jeu */}
                          <ImageCache
                            src={game.iconHash ? `/games-icons/${game.iconHash}` : "/games-icons/default.avif"}
                            alt={game.name}
                            className="w-24 h-24 object-contain rounded-xl glass-card border-2 border-glass-border"
                            cacheKey={`icon_${game.gameId}`}
                          />
                          <div>
                            <h3 className="text-2xl font-bold" style={{color: 'var(--glass-text)'}}>{game.name}</h3>
                            {game.genre && (
                              <span className="text-sm" style={{color: 'var(--glass-text-secondary)'}}>{game.genre}</span>
                            )}
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                          <FontAwesomeIcon icon={faStar} className="text-neon-yellow" />
                          <span className="text-sm font-semibold" style={{color: 'var(--glass-text-secondary)'}}>4.8</span>
                        </div>
                      </div>
          ...
          {games.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all duration-300 ${
                index === currentIndex 
                  ? 'bg-neon-blue' 
                  : 'bg-glass-border hover:bg-glass-accent'
              }`}
            />
          ))}
        </div>
    ...
    return (
      <>
        <div className="glass-page-container">
          {/* Hero Section avec thème sombre et étoiles */}
          <div className="glass-card mb-12 text-center relative overflow-hidden">
            {/* Étoiles scintillantes dans la carte */}
            <div className="absolute inset-0 pointer-events-none">
              <div className="twinkling-star" style={{top: '15%', left: '20%', animationDelay: '0s'}}></div>
              <div className="twinkling-star" style={{top: '25%', right: '20%', animationDelay: '1s'}}></div>
              <div className="twinkling-star" style={{bottom: '30%', left: '30%', animationDelay: '2s'}}></div>
              <div className="twinkling-star" style={{top: '40%', right: '30%', animationDelay: '0.5s'}}></div>
            </div>
            ...
            <div className="mb-8 relative z-10">
              <h1 className="text-5xl font-bold mb-6 bg-gradient-to-r from-neon-blue via-neon-purple to-neon-pink bg-clip-text text-transparent">
                Bienvenue dans l'univers Croissant
            </h1>
              <p className="text-xl mb-8" style={{color: 'var(--glass-text-secondary)'}}>
                Plongez dans l'univers gaming ultime avec des étoiles filantes et une expérience immersive unique
              </p>
          ...
          {/* Section Open Source */}
          <div className="glass-content-card mb-12">
            <h2 className="text-center mb-8" style={{color: 'var(--glass-text)', fontSize: '1.5rem', fontWeight: 'bold'}}>Projet Open Source</h2>
            <div className="text-center mb-8">
              <div className="text-6xl mb-4 text-neon-blue">
                <FontAwesomeIcon icon={faHandshake} />
              </div>
              <h3 className="text-2xl font-bold mb-4" style={{color: 'var(--glass-text)'}}>Contribuez à l'Évolution</h3>
              <p className="text-lg mb-6" style={{color: 'var(--glass-text-secondary)'}}>
                Croissant est un projet <strong style={{color: 'var(--glass-text)'}}>open source</strong> où chaque contribution compte. 
                Rejoignez notre communauté de développeurs passionnés et aidez-nous à façonner l'avenir du gaming.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="glass-card text-center">
                ...
                <h4 className="font-semibold mb-2" style={{color: 'var(--glass-text)'}}>Développement</h4>
                <p className="text-sm" style={{color: 'var(--glass-text-secondary)'}}>Code, features, corrections de bugs</p>
              </div>
              <div className="glass-card text-center">
                <div className="text-3xl mb-3 text-neon-purple">
                  <FontAwesomeIcon icon={faPalette} />
                </div>
                <h4 className="font-semibold mb-2" style={{color: 'var(--glass-text)'}}>Design</h4>
                <p className="text-sm" style={{color: 'var(--glass-text-secondary)'}}>UI/UX, graphismes, animations</p>
              </div>
              <div className="glass-card text-center">
                <div className="text-3xl mb-3 text-neon-green">
                  <FontAwesomeIcon icon={faFileText} />
                </div>
                <h4 className="font-semibold mb-2" style={{color: 'var(--glass-text)'}}>Documentation</h4>
                <p className="text-sm" style={{color: 'var(--glass-text-secondary)'}}>Guides, tutoriels, traductions</p>
              </div>
              <div className="glass-card text-center">
                <div className="text-3xl mb-3 text-neon-orange">
                  <FontAwesomeIcon icon={faFlask} />
                </div>
                <h4 className="font-semibold mb-2" style={{color: 'var(--glass-text)'}}>Tests</h4>
                <p className="text-sm" style={{color: 'var(--glass-text-secondary)'}}>QA, feedback, suggestions</p>
              </div>
            </div>
            <div className="text-center mt-8">
              <button className="glass-button-neon glass-glow">
      ...
      <>
        <div className="glass-page-container !max-w-[1000px]">
          ...
          <div className="glass-card !mt-0 !mx-0 mb-8 text-center relative overflow-hidden">
            {/* Étoiles scintillantes dans la carte */}
            <div className="absolute inset-0 pointer-events-none">
              <div className="twinkling-star" style={{top: '20%', left: '15%', animationDelay: '0s'}}></div>
              <div className="twinkling-star" style={{top: '30%', right: '15%', animationDelay: '1s'}}></div>
              <div className="twinkling-star" style={{bottom: '25%', left: '25%', animationDelay: '2s'}}></div>
            </div>
            
            <div className="mb-6 relative z-10">
              <h1 className="text-3xl font-bold mb-4 bg-gradient-to-r from-neon-blue via-neon-purple to-neon-pink bg-clip-text text-transparent">
                Bienvenue dans l'univers Croissant
              </h1>
          ...
          <div className="glass-content-card !mt-4 !mx-0 mb-6">
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="text-lg font-bold mb-3" style={{color: 'var(--glass-text)'}}>Contribuez à l'Évolution</h3>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="glass-card text-center !p-3">
                ...
                <h4 className="font-semibold text-sm mb-1" style={{color: 'var(--glass-text)'}}>Développement</h4>
                <p className="text-xs" style={{color: 'var(--glass-text-secondary)'}}>Code, features, bugs</p>
              </div>
              <div className="glass-card text-center !p-3">
                <div className="text-2xl mb-2 text-neon-purple">
                  <FontAwesomeIcon icon={faPalette} />
                </div>
                <h4 className="font-semibold text-sm mb-1" style={{color: 'var(--glass-text)'}}>Design</h4>
                <p className="text-xs" style={{color: 'var(--glass-text-secondary)'}}>UI/UX, graphismes</p>
              </div>
              <div className="glass-card text-center !p-3">
                <div className="text-2xl mb-2 text-neon-green">
                  <FontAwesomeIcon icon={faFileText} />
                </div>
                <h4 className="font-semibold text-sm mb-1" style={{color: 'var(--glass-text)'}}>Documentation</h4>
                <p className="text-xs" style={{color: 'var(--glass-text-secondary)'}}>Guides, traductions</p>
              </div>
              <div className="glass-card text-center !p-3">
                <div className="text-2xl mb-2 text-neon-orange">
                  <FontAwesomeIcon icon={faFlask} />
                </div>
                <h4 className="font-semibold text-sm mb-1" style={{color: 'var(--glass-text)'}}>Tests</h4>
                <p className="text-xs" style={{color: 'var(--glass-text-secondary)'}}>QA, feedback</p>
              </div>
            </div>
