        ...
        <div className="flex items-center justify-between mb-12">
          <div>
            ...
            <p className="text-glass-text-secondary text-xl">
              Templates Instagram carrés avec style glassmorphism pour Croissant
            </p>
          </div>
            ...
            <div key={index} className="glass-content-card text-center">
              ...
              <div className="flex gap-3 justify-center">
                <button
                  ...
                  className="glass-button-neon flex items-center gap-2"
                >
            ...
            <div className="glass-card  w-full max-h-[90vh] overflow-y-auto">
              <div className="flex justify-between items-start mb-6">
                ...
                <button
                  ...
                  className="glass-button text-glass-text-secondary hover:text-glass-text"
                >
                  ✕
                </button>
              </div>
...
{`<InstagramPost
  ...
  size="${selectedConfig.props.size}"${selectedConfig.props.features ? `
