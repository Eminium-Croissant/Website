      ...
      <div className="glass-page-container">
        ...
        <div className="glass-content-card mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="glass-card">
              <h3 className="text-xl font-semibold mb-4" style={{color: 'var(--glass-text)'}}>Carte Standard</h3>
              <p style={{color: 'var(--glass-text-secondary)'}}>
                Une carte avec le style glassmorphism sombre, incluant des effets de transparence et blur subtils.
              </p>
            </div>
            <div className="glass-card glass-glow">
              <h3 className="text-xl font-semibold mb-4" style={{color: 'var(--glass-text)'}}>Carte avec Glow</h3>
              <p style={{color: 'var(--glass-text-secondary)'}}>
                Cette carte a un effet de glow au survol, parfait pour les éléments importants.
              </p>
            </div>
            <div className="glass-card glass-shimmer">
              <h3 className="text-xl font-semibold mb-4" style={{color: 'var(--glass-text)'}}>Carte Shimmer</h3>
              <p style={{color: 'var(--glass-text-secondary)'}}>
                Cette carte a un effet de shimmer continu, idéal pour les éléments premium.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="glass-content-card mb-12">
          ...
          <div className="space-y-8">
            <div>
              ...
              <input 
                type="text" 
                placeholder="Rechercher dans les étoiles..." 
            ...
            <div>
              ...
              <textarea 
                placeholder="Écrivez votre message sous les étoiles..." 
        ...
        <div className="glass-content-card mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            <div className="text-center">
              ...
              <span className="text-sm" style={{color: 'var(--glass-text-secondary)'}}>Neon Blue</span>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-neon-purple rounded-xl mx-auto mb-3 shadow-glass-glow"></div>
              <span className="text-sm" style={{color: 'var(--glass-text-secondary)'}}>Neon Purple</span>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-neon-pink rounded-xl mx-auto mb-3 shadow-glass-glow"></div>
              <span className="text-sm" style={{color: 'var(--glass-text-secondary)'}}>Neon Pink</span>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-neon-green rounded-xl mx-auto mb-3 shadow-glass-glow"></div>
              <span className="text-sm" style={{color: 'var(--glass-text-secondary)'}}>Neon Green</span>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-neon-orange rounded-xl mx-auto mb-3 shadow-glass-glow"></div>
              <span className="text-sm" style={{color: 'var(--glass-text-secondary)'}}>Neon Orange</span>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-neon-yellow rounded-xl mx-auto mb-3 shadow-glass-glow"></div>
              <span className="text-sm" style={{color: 'var(--glass-text-secondary)'}}>Neon Yellow</span>
            </div>
          </div>
        </div>
        ...
        <div className="glass-content-card mb-12">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/" className="glass-nav">Accueil</Link>
            <Link href="/marketplace" className="glass-nav">Marketplace</Link>
            <Link href="/game-shop" className="glass-nav">Boutique</Link>
            <Link href="/api-docs" className="glass-nav">Documentation</Link>
            <Link href="/settings" className="glass-nav">Paramètres</Link>
          </div>
        </div>
        ...
        <div className="glass-content-card mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="glass-card text-center animate-glass-pulse">
              ...
              <p className="text-sm" style={{color: 'var(--glass-text-secondary)'}}>Animation pulsante</p>
            </div>
            <div className="glass-card text-center animate-star-twinkle">
              <div className="text-3xl mb-3">✨</div>
              <h3 className="font-semibold mb-2">Shimmer</h3>
              <p className="text-sm" style={{color: 'var(--glass-text-secondary)'}}>Animation brillante</p>
            </div>
          </div>
        </div>
