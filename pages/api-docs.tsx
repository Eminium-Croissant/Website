            ...
            <aside
              ...
              <ul className='list-none p-0 flex flex-col space-y-2.5'>
                {sdkLanguages.map(sdk => {
                  ...
                  return (
                    <li key={id}>
                      <a href={`https://github.com/Eminium-Croissant/Website/tree/main/public/downloadables/sdk-${id}/README.md`} target='_blank' rel='noreferrer' className='text-neon-blue no-underline hover:text-neon-purple transition-colors flex items-center gap-2'>
