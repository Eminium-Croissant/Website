              ...
              <div className="glass-card mt-4 p-6">
                <div className="space-y-4">
                  <p style={{ color: 'var(--glass-text-secondary)' }}>
                    Croissant est édité par Fox (fox3000foxy), développeur indépendant basé en France. Pour toute question ou demande concernant le
                    site, vous pouvez nous contacter via Discord ou par email à l'adresse indiquée sur notre serveur officiel,{' '}
                    <a href="mailto:croissant@eminium.ovh" className="text-neon-blue hover:text-neon-purple transition-colors">
                      croissant@eminium.ovh
                    </a>
                    .
                  </p>
                  <p style={{ color: 'var(--glass-text-secondary)' }}>
                    Les données personnelles collectées sont uniquement utilisées pour le bon fonctionnement du service et ne sont jamais revendues à
                    des tiers.
                  </p>
                  <p style={{ color: 'var(--glass-text-secondary)' }}>
                    Le site est hébergé par HG-Hosting.fr, une entreprise basée en France, dont le CEO est Lima M. Pour toute question relative à
                    l'hébergement, vous pouvez contacter HG-Hosting.fr à{' '}
          ...
          <div className="glass-card">
            ...
            {openEn && (
              <div className="glass-card mt-4 p-6">
                <div className="space-y-4">
                  <p style={{ color: 'var(--glass-text-secondary)' }}>
                    Croissant is published by Fox (fox3000foxy), an independent developer based in France. For any questions or requests regarding the
                    site, you can contact us via Discord or by email at the address provided on our official server,{' '}
                    <a href="mailto:croissant@eminium.ovh" className="text-neon-purple hover:text-neon-pink transition-colors">
                      croissant@eminium.ovh
                    </a>
                    .
                  </p>
                  ...
                  <p style={{ color: 'var(--glass-text-secondary)' }}>
                    The site is hosted by HG-Hosting.fr, a company based in France, whose CEO is Lima M. For any questions relating to hosting, you
                    can contact HG-Hosting.fr at{' '}
