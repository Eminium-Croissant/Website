      ...
      <div className="glass-content-card max-w-4xl mx-auto">
        ...
        <div className="glass-content-card mb-8">
          ...
          <div className="glass-card p-6 mb-6">
            ...
            <p className="mb-3" style={{color: 'var(--glass-text-secondary)'}}>{t("tos.1.1")}</p>
          ...
          <div className="glass-card p-6 mb-6">
            ...
            <p className="mb-3" style={{color: 'var(--glass-text-secondary)'}}>{t("tos.2.1")}</p>
            <p className="mb-3" style={{color: 'var(--glass-text-secondary)'}}>{t("tos.2.2")}</p>
          ...
          <div className="glass-card p-6 mb-6">
            ...
            <p className="mb-3" style={{color: 'var(--glass-text-secondary)'}}>{t("tos.3.1")}</p>
            <p className="mb-3" style={{color: 'var(--glass-text-secondary)'}}>{t("tos.3.2")}</p>
          ...
          <div className="glass-card p-6 mb-6">
            ...
            <p className="mb-3" style={{color: 'var(--glass-text-secondary)'}}>{t("tos.4.1")}</p>
            <p className="mb-3" style={{color: 'var(--glass-text-secondary)'}}>{t("tos.4.2")}</p>
          ...
          <div className="glass-card p-6 mb-6">
            ...
            <p className="mb-3" style={{color: 'var(--glass-text-secondary)'}}>{t("tos.5.1")}</p>
            <p className="mb-3" style={{color: 'var(--glass-text-secondary)'}}>{t("tos.5.2")}</p>
          ...
          <div className="glass-card p-6 mb-8">
            ...
            <p className="mb-3" style={{color: 'var(--glass-text-secondary)'}}>{t("tos.6.1")}</p>
        ...
        <div className="glass-card mb-6">
          <button
            ...
            className="glass-button-neon w-full flex items-center justify-between p-4 text-left"
          >
            ...
            <FontAwesomeIcon 
              icon={openFr ? faChevronUp : faChevronDown} 
        ...
        <div className="glass-card">
          ...
          >
            ...
            <FontAwesomeIcon 
              icon={openEn ? faChevronUp : faChevronDown} 
