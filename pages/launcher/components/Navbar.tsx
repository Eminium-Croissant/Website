        ...
        <div className='flex items-center justify-between max-w-[1400px] mx-auto px-6'>
          <div className='flex items-center mr-8'>
            <Link href='/launcher/home' className='text-glass-text no-underline font-bold text-2xl tracking-wider transition-all duration-300 hover:scale-105'>
              <span className='cursor-pointer flex items-center group'>
                <div className='relative'>
                  <CachedImage src='/assets/icons/favicon-32x32.avif' alt='Croissant Logo' className='w-10 h-10 relative -top-1 align-middle mr-4 transition-all duration-300 group-hover:' />
          ...
          <nav>
            <div className='flex items-center gap-4 mt-0 flex-row relative'>
              ...
              <Link href='/game-shop' className='no-underline px-4 py-2 rounded-xl transition-all duration-300 hover:scale-105 text-glass-text-secondary hover:text-neon-blue hover:bg-glass-accent hover:shadow-glass-glow text-xs font-medium'>
                Shop
              </Link>
              <Link href='/launcher/home' className='no-underline px-4 py-2 rounded-xl transition-all duration-300 hover:scale-105 text-glass-text-secondary hover:text-neon-blue hover:bg-glass-accent hover:shadow-glass-glow text-xs font-medium'>
                Library
              </Link>
