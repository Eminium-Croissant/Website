    ...
    <div className="min-h-screen bg-genshin-gradient">
      <div className="page-container">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-genshin-gold via-genshin-blue to-genshin-purple bg-clip-text text-transparent">
            Démonstration du Thème Genshin Impact
          </h1>
          <p className="text-dark-textSecondary text-xl">
            Découvrez tous les nouveaux composants et styles harmonieux inspirés de Genshin Impact
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="genshin-card">
              ...
              <p className="text-dark-textSecondary">
                Une carte avec le style Genshin Impact standard, incluant des effets de hover et des animations.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input 
                ...
                className="w-full px-4 py-2 bg-dark-surfaceLight border border-dark-surfaceLight rounded-xl text-dark-text placeholder-dark-textMuted focus:outline-none focus:border-genshin-blue focus:ring-2 focus:ring-genshin-blue/20 transition-all duration-300"
              />
            </div>
        ...
        <div className="genshin-card mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/game-shop" className="nav-link">Boutique</Link>
            <Link href="/api-docs" className="nav-link">Documentation</Link>
          </div>
        </div>
