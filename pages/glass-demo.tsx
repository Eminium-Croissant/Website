      ...
      <div className="glass-page-container">
        <div className="text-center mb-12">
          <h1 className="text-6xl font-bold mb-6 bg-gradient-to-r from-neon-blue via-neon-purple to-neon-pink bg-clip-text text-transparent">
            Démonstration Glassmorphism
          </h1>
          <p className="text-glass-text-secondary text-xl">
            Découvrez tous les composants glassmorphism avec des effets de verre et transparence
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="glass-card">
              ...
              <p className="text-glass-text-secondary">
                Une carte avec le style glassmorphism standard, incluant des effets de transparence et blur.
              </p>
            </div>
        ...
        {/* Éléments d'interface Glassmorphism */}
        <div className="glass-content-card mb-12">
          <h2 className="glass-title mb-8">Éléments d'Interface</h2>
          <div className="space-y-8">
            <div>
              <label className="block text-sm font-medium text-glass-text-secondary mb-3">
                Champ de recherche glassmorphism
              </label>
              <input 
                type="text" 
